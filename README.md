...
## Momentum Boot Camp Project 13

Skills:

- creating my own wireframe
- multiple pages in a React app
- pulling data from an API
- randomizing the order of data being displayed
- giving feedback based on user's input
- allowing user to start a new quiz any time
